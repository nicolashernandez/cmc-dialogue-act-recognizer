...
python applications/libshorttext-1.1/text-predict.py /tmp/libshortext-predict-input models/ubuntu-fr-all-train-3000-function-libshortext-model /tmp/libshortext-function-hyp-output
cat /tmp/libshortext-function-hyp-output | tail -n +7 | cut -f 1 > /tmp/libshortext-function-hyp
paste /tmp/libshortext-function-hyp $INPUTFILE 